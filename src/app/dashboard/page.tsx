...
// Import the new Paystack server actions.
import {
  createCancelSession,
      ...
      <div className="flex flex-col gap-8 mb-8">
        ...
        {tier != subscriptionTiers.Free && (
          <Card>
            ...
            <CardContent>
              {/* This form now calls the Paystack customer portal action. */}
...
function PricingCard({
  ...
  return (
    <Card className="shadow-none rounded-3xl overflow-hidden">
      ...
      <CardContent>
        {/* The form action now correctly calls createCancelSession for the Free plan and createCheckoutSession for paid plans. */}
        <form
          action={
            name === "Free"
              ? createCancelSession
